...
I'm a versatile **MERN Stack Developer** and **Front-End Designer** focused on crafting clean, user-friendly experiences. I am passionate about building excellent software that improves the lives of those around me.

More recently, I have expanded my toolkit into **Exploratory Data Analysis (EDA)** and **Data Visualization**, leveraging these skills to better understand user behavior and application performance.

## 🚀 Technical Skills

* **Full Stack (MERN):** **REACT** / **Node.js** / **Express.js** / **MongoDB**
* **Web Fundamentals:** JavaScript (JS) / Firebase / HTML / CSS / Tailwind CSS / Bootstrap
* **Data Analysis & Visualization (NEW):** **Seaborn** / **Pandas** / **Matplotlib** / EDA

## 🔭 Current Role

I am currently working as a **IT & Reservation Executive** at Flynas Airlines. As a dedicated employee, Manage Agent data and analysis it. | Booking & Ticketing.
...
[[Image of Box Plot components](https://i.ibb.co.com/CpTgcCXT/output.png)]
